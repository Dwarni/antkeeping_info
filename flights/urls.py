...
urlpatterns = [
    ...
    path(
        "<int:pk>/info-window",
        views.FlightInfoWindow.as_view(),
    ...
    path(
        "habitat-tags-autocomplete",
        views.HabitatTagAutocomplete.as_view(),
        name="flight_habitat_tags_autocomplete",
    ),
    path("top-lists", views.TopLists.as_view(), name="flights_top_lists"),
]

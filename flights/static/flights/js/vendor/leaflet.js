      ...
      _onMove: function (t) {
        ...
        this._enabled &&
          (t.touches && 1 < t.touches.length
            ? (this._moved = !0)
            : (!(e = new p(
                (e = t.touches && 1 === t.touches.length ? t.touches[0] : t)
                  .clientX,
                e.clientY,

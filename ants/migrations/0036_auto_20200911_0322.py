...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ants', '0035_auto_20200604_1535'),
    ]

    operations = [
        migrations.AlterField(
            model_name='antspecies',
            name='worker_polymorphism',
            field=models.BooleanField(blank=True, null=True, verbose_name='Worker polymorphism'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='native',
            field=models.BooleanField(blank=True, null=True, verbose_name='Native'),
        ),
        migrations.AlterField(
            model_name='distribution',
            name='protected',
            field=models.BooleanField(blank=True, null=True, verbose_name='Protected by law'),
        ),
        migrations.AlterField(
